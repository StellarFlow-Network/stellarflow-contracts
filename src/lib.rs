...
pub enum ContractError {
    ...
    // The upstream/main merge dropped these discriminants; every module below
    // still references them by name, so they are re-added verbatim.
